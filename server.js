...
// --- Dropzone + file picker (UI only for now) ---
...
function handleFiles(files) {
  ...
  // TODO: parse CSV and move to Step 2 (preview)
...
if (importNextBtn) {
  importNextBtn.addEventListener('click', () => {
    // TODO: When you build Step 2, you’ll:
    //  - Parse CSV or pasted DOTs
    //  - Show preview table
    //  - Advance step indicator
    console.log('Next clicked – wire to preview step later.');
  });
}
